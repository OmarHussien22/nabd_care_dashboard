    ...
    return AnimatedWrapper(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const CustomText("Dashboard Statistics",
                fontSize: 24,
                fontWeight: FW.bold,
                color: AppPalette.textPrimary),
            const SizedBox(height: 8),
            const CustomText("Overview of clinic performance",
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const CustomText("Weekly Bookings",
                            ...
                            child: BarChart(
                              BarChartData(
                                ...
                                barGroups: [
                                  ...
                                  _makeBarGroup(
                                      3, 8, AppPalette.secondary), // Peak day
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const CustomText("Patient Growth",
                              fontSize: 16, fontWeight: FW.semiBold),
                          const SizedBox(height: 24),
                          Expanded(
                            child: LineChart(
                          ...
                          const Row(
                            ...
                            children: [
                              CustomText("New Patients: 24",
                                  fontWeight: FW.medium),
                              CustomText("+12% vs last week",
                                  color: AppPalette.success, fontSize: 11),
                            ],
                          )
                        ],
                      ),
